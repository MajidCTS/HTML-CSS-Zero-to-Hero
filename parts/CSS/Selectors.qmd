...
**Attribute selector**
می توان عناصری که خاصیت مشخصی دارند نیز انتخاب کرد:
```css
a[target="_blank"] {
    background-color: yellow;
}
```
این کد هایپرلینک هایی که در پنجره جدید باز می شوند انتخاب خواهد کرد.
همچنین اگر آیتم هایی مثل فلش معنی خاصی در سایت دارند می توان به کمک خاصیت زیر برای RTL ها کارکرد آنها را تغییر داد:
...
|-----------------------|-------------------|------------------|--------------------------------------------------------|
|                       | وجود دارد         | [title]          | المان‌هایی که ویژگی <br>title<br> را دارند (هر مقداری) |
| =                     | دقیقاً برابر      | [type="text"]    | مقدار دقیقاً برابر با                                  |
| ~=                    | شامل کلمه         | [class~="btn"]   | مقدار شامل کلمه <br>"btn"<br> باشد (با فاصله جدا شده)  |
| |=                    | شروع با value-    | [class|="top"]   | دقیقاً <br>"top" <br>یا شروع با <br>"top-"             |
| ^=                    | شروع با           | [class^="top"]   | مقدار با "top" شروع شود (هر چیزی)                      |
| $=                    | خاتمه با          | [href$=".pdf"]   | مقدار با <br>".pdf"<br> تمام شود                       |
| *=                    | شامل              | [class*="btn"]   | مقدار شامل <br>"btn"<br> در هر جایی باشد               |
...
```
Marker ها در لیست های مرتب و بدون ترتیب استفاده می شوند.
همچنین از طریق انتخاب زیر می توان روی عناصری که کاربر انتخاب کرده تغییراتی اعمال کرد:
```css
::selection {
    color: red;
    background: yellow;
...
<div class="output ltr" id="samplediv15">
...
<div class="output ltr" id="samplediv16">
    <input type="text" placeholder="this is a custom placeholder" size="30">
</div>
```
...
```{=html}
<style>
    #samplediv18 dialog::backdrop {
        background-color: rgb(0, 0, 0, .8);
    }
</style>
<div class="output ltr" id="samplediv18">
    <button popovertarget="favDialog">Show a dialog</button>
    <dialog id="favDialog" popover>
        <p>The background shown outside of this dialog is a backdrop.</p>
        <button popovertarget="favDialog" popovertargetaction="hide">Close the dialog</button>
    </dialog>
</div>
```
...
هر چقدر وزن یک selector بیشتر باشد اولویت بالاتری دارد.
برای کنترل ساده تر وزن ها به جای حفظ روش بالا چند تکنیک ساده را رعایت می کنیم:

- از <bid>!important</bdi> فقط در موارد ضروری استفاده کنید (مثل کلاس‌های utility در چارچوبهایی نظیر بوت استرپ و Tailwind)
